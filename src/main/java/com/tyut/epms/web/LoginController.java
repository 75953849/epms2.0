...
public class LoginController {
	...
	public String register(Login login,HttpServletRequest req) {
		System.out.println(login.getLoginName()+login.getLoginPassword());;
		int res = loginService.addLogin(login);
	...
	@RequestMapping("/toRoleError")
	public String toRoleError() {
		return "roleError";
	}
